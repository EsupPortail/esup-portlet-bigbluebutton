...
var SpanBorderColor = "#5A95CF";//span border color
var SpanBgColor = "#FFFFFF"; //span background color
var MonthYearColor = "#cc0033"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#336699"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#ACC9E6"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#ACC9E6"; //Background color of Saturday.
var WeekDayColor = "#DFEFFF"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#ffbd35"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#336699"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
...
var imageFilesPath = "/esup-portlet-bigbluebutton/images/";
...
function RenderCssCal(bNewCal)
{
	...
	if (!winCal)
	{
		...
		cssStr += "#"+calSpanID+" th, #"+calSpanID+" td {padding: 0;}";
